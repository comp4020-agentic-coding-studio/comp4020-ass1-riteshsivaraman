...
| Sim 3 observed label cut off at the end | broken | A label anchored to a moving mark can leave its clipping container | label-containment (`data-label`) | `a6f0f37` |
| Sim 2 emitter/receiver unlabelled | broken | Regression: names lost when labels moved out of the SVG | label-presence + tracking tests | `a6f0f37` |
